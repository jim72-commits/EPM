...
import { confirmAlertUnsubscribe } from "@/app/alerts/unsubscribe/actions";
  ...
  return (
    <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col px-6 py-16 lg:px-8 lg:py-24">
      ...
      <p className="mt-6 text-base leading-relaxed text-muted">
        Click below to remove this alert. Your other alerts and newsletter
        subscriptions stay active.
      </p>

      <form action={confirmAlertUnsubscribe} className="mt-8">
      ...
      {!token ? (
        <p className="mt-4 text-sm text-muted">
          Missing token — use the unsubscribe link from any alert digest email.
        </p>
      ) : null}
